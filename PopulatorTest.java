...
public class PopulatorTest {
    ...
    public void milestoneA2() throws IOException {
        try {
            String[] tables = new String[] { "D", "L", "B", "F", "T", "S", "R" };
    ...
    public void milestoneB1() throws Exception {
        assertTrue(cat.hasPrimaryKeys(instance.sqliteConn(), "S"));
    }
    ...
    public void milestoneB2() throws Exception {
        TreeMap<String, Attribute> atts = cat.tableAttributes(instance.sqliteConn(), "S");
        Attribute a = atts.get("a");
        assertTrue(a != null);
     ...
     * DATA FILE HERO.CSV:\\
     * 
     * r,g,a,q,p\\ 101,'Eric Noel','2001-12-25','Eric Noel', 'Santa
     * Clause'
     * 
     * SQL
     * 
     ...
     * '2001-012-25' ); -- assuming this does not exist INSERT INTO R(r,q,p)
    ...
    public void milestoneF() throws Exception {
        ...
        instance.insertCSVData(csvFile, new String[] { "S", "R" }, new String[] { "ISA" });
        try (ResultSet rs = instance.sqliteConn().createStatement().executeQuery("select * from S where r=101")) {
            assertTrue(rs.next());
        }
        try (ResultSet rs = instance.sqliteConn().createStatement()
                .executeQuery("select * from R where r=101 and p='Santa Clause'")) {
            assertTrue(rs.next());
        }
    }
     ...
     * 
     * CREATE INDEX planets_id ON D (c);
     * 
     * @throws SQLException
     * 
     */
    ...
    public void checkAgeUpdate() throws Exception {
        String sql = "INSERT OR IGNORE INTO S(r,g,a,j) VALUES( 10101, 'Eric Bell', '1982-02-25',5 );";
        instance.exec(sql);
        instance.updateAllAges();
        try (ResultSet rs = instance.sqliteConn().createStatement().executeQuery("select * from S where r=10101")) {
            assertTrue(rs.next());
            LocalDate dob = new SimpleDateFormat("yyyy-MM-dd")
                    .parse(rs.getString("a"))
                    .toInstant()
